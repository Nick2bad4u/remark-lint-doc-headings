...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/remark-lint-doc-headings/security/advisories/new>
...
- Keep `remark-lint-doc-headings`, remark, and dependencies updated.
- Treat diagnostics from untrusted Markdown as advisory until reviewed.
- Prefer explicit include and exclude globs in shared CI configurations.
